 ...
 */
public class ReloaderMonitor {

    private static final Logger logger = LogManager.getLogger(ReloaderMonitor.class);
    ...
    public void startWatchFileChange(String watchPath, String fileName) throws IOException {
        ...
        observer.addListener(new FileAlterationListenerAdaptor() {
			...
			public void onFileChange(File file) {
				...
				Reloader.loadFromZipFile(file.getAbsolutePath());
			}
    ...
    public static ReloaderMonitor newOne() {
        return new ReloaderMonitor();
    }
}
